...
+function ($) {
  ...
  Pongstgrm.prototype.template = {
    ...
    , thumb: function (options) {
      ...
      options.data.username !== false ?
        _thumbnail += '<span class="username">' + options.data.username + '</span>' : ""

      options.data.likes !== false ?
        _thumbnail += '<span class="likes"><i class="' + options.dflt.likeicon + '"></i>&nbsp;' + '<span>'  + options.data.likes_count + '</span>'  + '</span>' : ""

      options.dflt.timestamp !== false ?
        _thumbnail += '<strong class="date-post">' + options.data.timestamp + '</strong>' : null
